...
public class ItemsAdapterAdmin extends RecyclerView.Adapter<ItemsAdapterAdmin.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_layout_test, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener, View.OnClickListener {
        ...
        public ViewHolder(@NonNull View itemView, ListClickListener mListClickListener) {
            super(itemView);
            foodname = itemView.findViewById(R.id.itemLayout_name_id_test);
            ratingText = itemView.findViewById(R.id.itemLayout_ratingText_id_test);
            des = itemView.findViewById(R.id.itemLayout_des_id_test);
            foodtype = itemView.findViewById(R.id.itemLayout_type_id_test);
            price = itemView.findViewById(R.id.itemLayout_price_id_test);
            foodimgeitems = itemView.findViewById(R.id.itemLayout_imgitems_id_test);
            ratingBar = itemView.findViewById(R.id.itemlayout_ratingBar_id_test);
